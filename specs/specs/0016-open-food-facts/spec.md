...
- [ ] 🌍 ¿`BarcodeDetector` alcanza? Está en Chrome/Android; Safari iOS no lo tiene. Va a hacer falta un fallback en JS.
  <br>🔓 **Se desbloquea con:** una prueba en el teléfono real de cada uno. Si alguno usa iOS, hace falta fallback en JS sí o sí.
- [x] ¿Se cachea la respuesta cruda o sólo lo mapeado? **Cruda, más el mapeo.** Ocupa poco y permite re-mapear si cambia el criterio, sin volver a pegarle a un servicio de terceros.
