...
# Registro de Funciones Puras (core/utils/)

> Funciones puras disponibles. **Consúltalo antes de escribir una util nueva**: lo más probable es que ya exista. Se regenera con `npm run indices:sync`.
