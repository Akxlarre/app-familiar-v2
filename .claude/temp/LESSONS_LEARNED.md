...
## 2026-08-11T22:41:39.483Z — Recuperación tras fallo ARCH
...
[33m📋 Reglas validadas:[0m
   ...
   ARCH-17 — Arbitrary font size — .claude/rules/visual-system.md
   ARCH-19 — Ad-hoc typography cluster — .claude/rules/visual-system.md
   ARCH-24 — Ad-hoc input cluster — .claude/rules/visual-system.md
   ARCH-23 — Fill-screen bento cell spanning 2 rows — .claude/rules/visual-system.md
   ARCH-25 — Contrast below WCAG AA — .claude/rules/visual-system.md
   A11Y-03 — Icon-only button without accessible name — .claude/rules/a11y-spec.md
   ICON-01 — Icon used but not registered — .claude/skills/design-system/SKILL.md
...
[31m🚨 [ARCH-24] Ad-hoc input cluster: Disciplina de clases del DS: 0 tolerado(s) → 3 ahora. Ej: w-full box-border rounded-[var(--input-radius)] border border-[var(--input-border-default)[0m
[36m   Archivo: src/app/features/auth/login/login.component.ts[0m
[33m   Fix: Usa .field-input (y .field-label) en vez de recomponer el cluster de borde + fondo + padding + radio sobre un campo.[0m
[36m   Doc: .claude/rules/visual-system.md[0m

[31m❌ Auditoría falló: 1 error(es), 2 advertencia(s).[0m
```

## 2026-08-12T02:14:16.839Z — Recuperación tras fallo ARCH
...
[36m   ℹ ICON-01: 11 archivo(s) usan [name] dinámico — no verificable estáticamente.[0m
...
[33m📋 Reglas validadas:[0m
   ...
   ARCH-23 — Fill-screen bento cell spanning 2 rows — .claude/rules/visual-system.md
   ARCH-25 — Contrast below WCAG AA — .claude/rules/visual-system.md
   ARCH-26 — Theme token collides with a native Tailwind utility — .claude/rules/visual-system.md
   A11Y-03 — Icon-only button without accessible name — .claude/rules/a11y-spec.md
   ICON-01 — Icon used but not registered — .claude/skills/design-system/SKILL.md
   ARCH-01 — No Supabase in UI — docs/TECH-STACK-RULES.md#arch-01
   ARCH-02 — Facade-only injection — docs/TECH-STACK-RULES.md#arch-02
...
[33m⚠️  [ARCH-09] Complexity warning (shared components): Clase demasiado grande (1170 líneas). Límite recomendado: 200.[0m
[36m   Archivo: src/app/shared/components/section-hero/section-hero.component.ts[0m
[33m   Fix: Divide el componente en subcomponentes o extrae lógica a servicios/utilidades. Mantén shared/ simple.[0m
[36m   Doc: docs/TECH-STACK-RULES.md#arch-09[0m
...
[31m🚨 [ARCH-26] Theme token collides with a native Tailwind utility: --color-base genera la utilidad de color `text-base`, que le gana a la nativa de la escala `text`.[0m
[36m   Archivo: src/tailwind.css[0m
[33m   Fix: Renombra el token: un --color-X donde X es un valor de una escala nativa (base, sm, lg, xl…) genera una utilidad de COLOR que le gana a la nativa. `--color-base` hacía que `text-base` pintara texto del color del fondo.[0m
[36m   Doc: .claude/rules/visual-system.md[0m

[31m❌ Auditoría falló: 1 error(es), 2 advertencia(s).[0m
```

## 2026-08-12T02:55:21.806Z — Recuperación tras fallo ARCH
...
[33m📋 Reglas validadas:[0m
   ...
   ARCH-25 — Contrast below WCAG AA — .claude/rules/visual-system.md
   ARCH-26 — Theme token collides with a native Tailwind utility — .claude/rules/visual-system.md
   NAV-01 — Menu entry without a declared route — .claude/rules/screen-contract.md
   A11Y-03 — Icon-only button without accessible name — .claude/rules/a11y-spec.md
   ICON-01 — Icon used but not registered — .claude/skills/design-system/SKILL.md
   ARCH-01 — No Supabase in UI — docs/TECH-STACK-RULES.md#arch-01
   ARCH-02 — Facade-only injection — docs/TECH-STACK-RULES.md#arch-02
...
[31m🚨 [NAV-01] Menu entry without a declared route: El menú apunta a /app/settings, que no existe en app.routes.ts.[0m
[36m   Archivo: src/app/core/services/menu-config.service.ts[0m
[33m   Fix: Toda entrada del menú tiene que resolver a una ruta de app.routes.ts. Si el módulo todavía no existe, la entrada NO va (spec 0003, AC4): un menú de promesas es lo que hace que el usuario entre a pantallas vacías y deje de abrir la app.[0m
[36m   Doc: .claude/rules/screen-contract.md[0m

[31m❌ Auditoría falló: 1 error(es), 2 advertencia(s).[0m
```

## 2026-08-12T15:58:21.246Z — Recuperación tras fallo ARCH
...
[31m🚨 [ARCH-02] Facade-only injection: Inyección directa de 'ToastService' en componente vista[0m
[36m   Archivo: src/app/features/plata/detalle-movimiento.component.ts[0m
[33m   Fix: Los componentes vista solo deben inyectar clases tipo Facade (*FacadeService).[0m
[36m   Doc: docs/TECH-STACK-RULES.md#arch-02[0m
...
## 2026-08-12T18:21:21.937Z — Recuperación tras fallo ARCH
...
[31m🚨 [ARCH-19] Ad-hoc typography cluster: Disciplina de clases del DS: 0 tolerado(s) → 1 ahora. Ej: item-title[0m
[36m   Archivo: src/app/features/onboarding/paso-listo.component.ts[0m
[33m   Fix: Usa .micro-label / .item-title / .section-eyebrow / .kpi-value en vez de recomponer el cluster de utilities.[0m
[36m   Doc: .claude/rules/visual-system.md[0m
